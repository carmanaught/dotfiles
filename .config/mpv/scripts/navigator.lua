...
local settings = {
  ...
  defaultpath = extSettings.defaultPath, --fallback if no file is open
  ...
  --  '/home/anon/'
  --},
  favorites = extSettings.favorites,
  ...
  osd_dur = 10,                 --osd duration before the navigator closes, if timeout is set to true
  osd_items_per_screen = 15,   --how many menu items to show per screen
  navigator_font_size = 30,    --the font size to use for the OSD while the navigator is open
...
function add_keybinds()
  ...
  mp.add_forced_key_binding('ESC', 'hidenav1', clearosd)
  mp.add_forced_key_binding('Ctrl+f', 'hidenav2', clearosd)
end
...
function remove_keybinds()
  if settings.dynamic_binds then
    ...
    mp.remove_key_binding('hidenav1')
    mp.remove_key_binding('hidenav2')
  end
end
